...
export interface MediaAttributes extends SharedAttributes {
  ...
  extmapAllowMixed?: string;
  iceOptions?: string;
  maxMessageSize?: number | string;
  content?: string;
  connectionType?: string;
  bfcpFloorCtrl?: string;
  bfcpConfId?: number | string;
  bfcpUserId?: number | string;
  bfcpFloorId?: { id?: number | string; mStream?: number | string };
  mediaClk?: {
    id?: string;
    mediaClockName?: string;
    mediaClockValue?: string | number;
...
export interface SharedDescriptionFields {
  ...
  bandwidth?:
    ...
    | undefined;
  tsRefClocks?: { clksrc?: string; clksrcExt?: number | string }[];
}
