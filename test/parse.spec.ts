...
const t = {
  ok: (condition, message) => expect(condition),
  equal: (a, b, message) => expect(a).toBe(b),
  deepEqual: (a, b, message) => expect(a).toEqual(b),
};

describe("sdp-transform", () => {
  it("normalSdp", async function () {
    const sdp = await fs.readFile(__dirname + "/normal.sdp", "utf8");
    ...
    t.equal(
      vidFmtp["packetization-mode"],
      1,
      "video fmtp 0 packetization-mode"
    );
    t.equal(
   ...
   * ignore the name
   */
  it("hackySdp", async function () {
    const sdp = await fs.readFile(__dirname + "/hacky.sdp", "utf8");
  ...
  it("iceliteSdp", async function () {
    const sdp = await fs.readFile(__dirname + "/icelite.sdp", "utf8");
    ...
    t.ok(
      rew.indexOf("m=") > rew.indexOf("a=ice-lite"),
      "session level icelite"
    );
  });

  it("invalidSdp", async function () {
    var sdp = await fs.readFile(__dirname + "/invalid.sdp", "utf8");
  ...
  it("jssipSdp", async function () {
    var sdp = await fs.readFile(__dirname + "/jssip.sdp", "utf8");
  ...
  it("jsepSdp", async function () {
    var sdp = await fs.readFile(__dirname + "/jsep.sdp", "utf8");
  ...
  it("alacSdp", async function () {
    var sdp = await fs.readFile(__dirname + "/alac.sdp", "utf8");
  ...
  it("onvifSdp", async function () {
    var sdp = await fs.readFile(__dirname + "/onvif.sdp", "utf8");
    ...
    t.equal(
      application.rtp[0].encoding,
      undefined,
      "application rtp 0 encoding"
    );
  });

  it("ssrcSdp", async function () {
    var sdp = await fs.readFile(__dirname + "/ssrc.sdp", "utf8");
  ...
  it("simulcastSdp", async function () {
    var sdp = await fs.readFile(__dirname + "/simulcast.sdp", "utf8");
    ...
    var imageattr1SendParams = parseImageAttributes(
    ...
    var imageattr1RecvParams = parseImageAttributes(
    ...
    var imageattr2SendParams = parseImageAttributes(
    ...
    var imageattr3SendParams = parseImageAttributes(
    ...
    var imageattr4RecvParams = parseImageAttributes(
    ...
    t.equal(
      video.imageattrs![4].attrs1,
      "*",
      "video 5th imageattr recv params"
    );
    ...
    var simulcastSendStreams = parseSimulcastStreamList(
    ...
    var simulcastRecvStreams = parseSimulcastStreamList(
  ...
  it("ST2022-6", async function () {
    var sdp = await fs.readFile(__dirname + "/st2022-6.sdp", "utf8");
    ...
    t.equal(
      ...
      "239.0.0.1",
      'dest-address is "239.0.0.1"'
    );
    t.equal(
      sourceFilter?.srcList,
      "192.168.20.20",
      'src-list is "192.168.20.20"'
    );
  });

  it("ST2110-20", async function () {
    var sdp = await fs.readFile(__dirname + "/st2110-20.sdp", "utf8");
  ...
  it("SCTP-DTLS-26", async function () {
    var sdp = await fs.readFile(__dirname + "/sctp-dtls-26.sdp", "utf8");
  ...
  it("extmapEncryptSdp", async function () {
    var sdp = await fs.readFile(__dirname + "/extmap-encrypt.sdp", "utf8");
  ...
  it("dante-aes67", async function () {
    var sdp = await fs.readFile(__dirname + "/dante-aes67.sdp", "utf8");
  ...
  it("bfcp", async function () {
    var sdp = await fs.readFile(__dirname + "/bfcp.sdp", "utf8");
  ...
  it("tcp-active", async function () {
    var sdp = await fs.readFile(__dirname + "/tcp-active.sdp", "utf8");
  ...
  it("tcp-passive", async function () {
    var sdp = await fs.readFile(__dirname + "/tcp-passive.sdp", "utf8");
  ...
  it("mediaclk-avbtp", async function () {
    var sdp = await fs.readFile(__dirname + "/mediaclk-avbtp.sdp", "utf8");
  ...
  it("mediaclk-ptp-v2-w-rate", async function () {
    var sdp = await fs.readFile(
  ...
  it("mediaclk-ptp-v2", async function () {
    var sdp = await fs.readFile(__dirname + "/mediaclk-ptp-v2.sdp", "utf8");
  ...
  it("mediaclk-rtp", async function () {
    var sdp = await fs.readFile(__dirname + "/mediaclk-rtp.sdp", "utf8");
  ...
  it("ts-refclk-media", async function () {
    var sdp = await fs.readFile(__dirname + "/ts-refclk-media.sdp", "utf8");
  ...
  it("ts-refclk-sess", async function () {
    var sdp = await fs.readFile(__dirname + "/ts-refclk-sess.sdp", "utf8");
